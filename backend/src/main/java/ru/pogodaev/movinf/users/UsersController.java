...
public class UsersController {
    ...
    public Iterable<UserListElement> getPagedList(@PathVariable("pageNum") Integer page,
    ...
    @GetMapping("/{userId}")
    public ResponseEntity<UserWithReviews> getSpecificUser(@PathVariable Long userId) {
        UserWithReviews foundUser = service.getUserById(userId);
        if (foundUser != null) {
